...
class TestEvolutionTracker:
    def test_creates_experiment_dir(self, tmp_path: Path) -> None:
        with patch("evolution.tracker._EXPERIMENTS_DIR", tmp_path):
            EvolutionTracker("my_exp")
        assert (tmp_path / "my_exp").is_dir()

    def test_log_and_retrieve_generation(self, tracker: EvolutionTracker) -> None:
    ...
    def test_get_best_generation(self, tracker: EvolutionTracker) -> None:
    ...
    def test_get_prompt(self, tracker: EvolutionTracker) -> None:
    ...
    def test_get_prompt_missing_returns_none(self, tracker: EvolutionTracker) -> None:
        assert tracker.get_prompt(99) is None

    def test_metrics_file_written(self, tracker: EvolutionTracker) -> None:
    ...
    def test_prompt_file_written(self, tracker: EvolutionTracker) -> None:
    ...
    def test_analysis_file_written(self, tracker: EvolutionTracker) -> None:
    ...
    def test_log_generation_deduplicates(self, tracker: EvolutionTracker) -> None:
    ...
    def test_empty_history_returns_none_for_best(self, tracker: EvolutionTracker) -> None:
        assert tracker.get_best_generation() is None

    def test_five_generations_sorted(self, tracker: EvolutionTracker) -> None:
...
class TestCostEstimation:
    def test_estimate_generation_cost_sonnet(self) -> None:
    ...
    def test_estimate_generation_cost_opus(self) -> None:
    ...
    def test_estimate_total_cost(self) -> None:
    ...
    def test_total_cost_scales_with_generations(self) -> None:
